...
export default {
  ...
  methods: {
    CasteloBranco () {
      this.$router.push('/detective-privado-em-Castelo-Branco/detective-privado-em-Castelo-Branco#sobre')
      this.$smoothScroll({
    ...
    Covilha () {
      this.$router.push('/detective-privado-em-Castelo-Branco/detective-privado-em-Covilha#sobre')
      this.$smoothScroll({
        scrollTo: document.getElementById('sobre'),
        duration: 500,
        offset: -70
