<template>
  <div class="">
    ...
    <div class="mt-xs-40 mt-sm-40 mt-lg-60 border-none">
      ...
      <p class="fw-600 text-xs-center text-sm-center text-lg-left fs-17">
        A infidelidade conjugal atualmente está se tornando algo banal, mas
        para a parte traída não é bem assim. Muitos são os problemas gerados por
        uma traição, traumas psicológicos, danos morais e financeiros entre outros.
      </p>
      <p class="fw-600 text-xs-center text-sm-center text-lg-left fs-17">
      ...
      <p class="fw-600 text-xs-center text-sm-center text-lg-left mt-10 fs-17">
        ...
        a semana e características físicas de cor de cabelo e tom de pele.
      </p>
      <p class="fw-600 text-xs-center text-sm-center text-lg-left fs-17">
        Após a coleta dos dados iniciais e contrato assinado, a Investigação Conjugal passa pelas seguintes etapas:
      </p>
      ...
      <p class="fw-600 text-xs-center text-sm-center text-lg-left mt-10 fs-17">
        ...
        tem duração de cinco a dez dias, dependendo da necessidade do cliente.
      </p>
      <h4 id="sinais-traicao" class="text-azul mt-30 fw-600 text-xs-center text-sm-center text-lg-left">
        3°: Reunião dos fatos
      </h4>
...
export default {
  ...
  head: {
    link: [
      { rel: 'alternate', href: 'https://iundep.com.br/servicos/investigacao-conjugal', hreflang: 'x-default' },
      { rel: 'alternate', href: 'https://iundep.com.br/servicos/investigacao-conjugal', hreflang: 'pt-br' },
      { rel: 'alternate', href: 'https://iundepdetectives.pt/servicos/investigacao-conjugal', hreflang: 'pt' }
    ]
  },
  mounted () {
    this.$smoothScroll({
