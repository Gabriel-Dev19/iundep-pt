  ...
  <div>
    ...
    <div class="mt-xs-40 mt-sm-40 mt-lg-60 border-none">
      ...
      <p class="fw-600 text-xs-center text-sm-center text-lg-left mt-10 fs-17">
        ...
        corrupção política e ao conjunto de Investigação Política em nosso País.
      </p>
      <p class="fw-600 text-xs-center text-sm-center text-lg-left fs-17">
        ...
        Quem nunca presenciou nos telejornais notícias de irregularidades políticas
      ...
      <p class="fw-600 text-xs-center text-sm-center text-lg-left fs-17">
        Como por exemplo, se houve uso ilegal do dinheiro público, tráfico de influência,
        obras superfaturadas, abertura de empresas fantasmas, utilização de nomes de laranjas,
      ...
      <p class="fw-600 text-xs-center text-sm-center text-lg-left fs-17">
        O objetivo é encontrar a “sujeira” de seu oponente ou seus assessores diretamente ligados
        a política, e, dado o direito do eleitor de saber o máximo possível sobre um candidato,
      ...
      <p class="fw-600 text-xs-center text-sm-center text-lg-left fs-17">
        Sempre mantendo o foco, nossos agentes recebem treinamentos para sempre estarem bem informados,
...
export default {
  ...
  head: {
    link: [
      { rel: 'alternate', href: 'https://iundep.com.br/servicos/investigacao-politica', hreflang: 'x-default' },
      { rel: 'alternate', href: 'https://iundep.com.br/servicos/investigacao-politica', hreflang: 'pt-br' },
      { rel: 'alternate', href: 'https://iundepdetectives.pt/servicos/investigacao-politica', hreflang: 'pt' }
    ]
  },
  mounted () {
    this.$smoothScroll({
...
<style scoped>
  .bg-card{
    background: linear-gradient(0deg, #000000c4, #00000067), url(../../../assets/img/investigacao-politica.webp) center center no-repeat;
