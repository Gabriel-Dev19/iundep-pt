    ...
    <div class="col-12 d-flex row mx-auto px-0">
      <div class="col-lg-7 px-0">
        <h2 class="text-azul fs-xs-28 fs-sm-30 fs-lg-32 text-xs-center text-sm-center text-lg-left fw-600">
          ...
          <br>
          Precisando de um detective privado em Vila Real?
        </h2>
        <p class="fw-600 text-xs-center text-sm-center text-lg-left mt-20 fs-18">
          A IUNDEP DETECTIVES está em Vila Real e queremos ajudar você a solucionar suas dúvidas.
    ...
    <section class="col-12 px-0">
      <div class="container px-xs-0">
        ...
        <div class="position-relative overflow-hidden col-12 d-flex row mx-auto pr-0 pt-1 pb-30 pl-45">
          ...
          <a class="d-flex col-12 mt-4 px-0 py-0 text-preto-cidades fs-sm-18 fw-700 btn align-items-center" @click.prevent="VilaReal">
            <span class="text-azul fw-700 fs-20 mr-1">#</span> Vila Real
          </a>
        </div>
      </div>
    </section>
...
export default {
  ...
  methods: {
    VilaReal () {
      this.$router.push('/detetive-particular-em-Vila-Real/detetive-particular-em-Vila-Real#sobre')
      this.$smoothScroll({
