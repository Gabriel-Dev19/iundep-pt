...
export default {
  ...
  methods: {
    Ourem () {
      this.$router.push('/detective-privado-em-Santarem/detective-privado-em-Ourem#sobre')
      this.$smoothScroll({
    ...
    Santarem () {
      this.$router.push('/detective-privado-em-Santarem/detective-privado-em-Santarem#sobre')
      this.$smoothScroll({
        scrollTo: document.getElementById('sobre'),
        duration: 500,
        offset: -70
