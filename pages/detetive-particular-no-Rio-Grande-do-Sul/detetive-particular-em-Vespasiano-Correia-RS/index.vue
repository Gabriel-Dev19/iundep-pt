    ...
    <div class="col-12 d-flex row mx-auto px-0">
      <div class="col-lg-7 px-0">
        <h2 class="text-azul fs-xs-28 fs-sm-30 fs-lg-32 text-xs-center text-sm-center text-lg-left fw-600">
          Detetive particular em Vespasiano Correia - RS.
          <br>
          Precisando de um detetive particular em Vespasiano Correia - RS?
        </h2>
        <p class="fw-600 text-xs-center text-sm-center text-lg-left mt-20 fs-18">
          A IUNDEP DETETIVES está em Vespasiano Correia - RS e queremos ajudar você a solucionar suas dúvidas.
        ...
        <h4 class="text-azul text-xs-center mt-4 text-sm-center text-lg-left fw-600">
          Entre em contato com um de nossos detetives em Vespasiano Correia - RS
        </h4>
...
export default {
  ...
  layout: 'LayoutSobre',
  head: {
    title: 'Detetive particular em Vespasiano Correia - RS | Balneário Camboriú | Florianópolis | Blumenau | Criciúma | Caçador | Porto Alegre | Maringá'
  }
}
</script>
<style scoped>
